...
class InfoModal extends Component {
  render() {
    ...
    return (
      <div>
        {isOpen && (
          <div id="info-modal" className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center z-50 p-4 overflow-x-hidden overflow-y-auto bg-gray-900 bg-opacity-75">
              ...
              <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div className="flex flex-col p-5 dark:border-gray-600">
                  ...
                  <div className='din-pro'>
                    Diese Webseite wurde als Portfolioprüfung im Rahmen der Vorlesung "Webprogrammierung" erstellt. 
                  </div>
                </div>
              </div>
            </div>
